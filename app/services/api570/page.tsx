        ...
        <section className="py-20 bg-gradient-to-r from-green-600 to-green-800">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Need API 570 Certified Piping Inspection Services?
            </h2>
            <p className="text-xl text-green-100 mb-8 max-w-3xl mx-auto">
              Our certified inspectors are ready to help ensure your piping systems meet all API 570 requirements for safety, compliance, and operational efficiency.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <button className="bg-white text-green-600 px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl">
                Get Free Quote
              </button>
