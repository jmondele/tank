            ...
            <div className="max-w-6xl mx-auto">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl p-8 md:p-12 border border-blue-200">
                <div className="flex items-start space-x-4 mb-8">
                  <h2 className="text-3xl md:text-4xl font-bold text-gray-900">NDT: The $10M Question Nobody Asks</h2>
                </div>
                ...
                <div className="text-gray-700 text-lg leading-relaxed space-y-6">
                  ...
                  <ul className="list-disc pl-6 space-y-3">
                    ...
                    <li>**No downtime** = Your operations keep running while we work</li>
                    <li>**Early detection** = We catch problems before they become disasters</li>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">
                NDT Questions I Answer Every Day
              </h2>
